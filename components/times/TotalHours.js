  ...
  return (
    <>
      <Card className="time h-full w-full lg:p-10 p-2 lg:text-6xl text-4xl">
        <div className="hours border rounded-xl border-gray-500 w-full h-full flex flex-col items-center justify-center">
          <div className="description text-lg flex justify-center">hours : </div>
